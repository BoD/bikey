 ...
 */
package org.jraf.android.bikey.app.hud.fragment.cadence;
...
public class CadenceHudFragment extends SimpleHudFragment {
    public static CadenceHudFragment newInstance() {
        return new CadenceHudFragment();
    }
